...
export const ReservationDetail = ({
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.title}>Username Auction Detail</div>
        ...
        {!isLoading && session && reservation ? (
          <>
            ...
            <div className={styles.item}>
              ...
              <div className={styles.value}>{reservation.user.screen_name}</div>
            </div>
            <div className={styles.item}>
              ...
              <>
                ...
                <div className={styles.notification}>
                  <Button
                    ...
                    onClick={() => toast.warning("Auction ends soon.")}
                  />
                </div>
              </>
            ) : (
